$(document)
		.ready(
				function() {
					...
					$.post("RecommendationController",
									{
										'track' : JSON.stringify(trackingJSON)
									},
									function(data) {
										...
										$("#recommended-artists").html(
												temp_artist);
										$("#recommended-tracks").html(
												temp_track);
										smallCovers();

										console
												.log("finished to create recommended elements!");
